...
public class ApproveTest {
    ...
    @Test
    public void testApproveOrder() throws InterruptedException {
        ...
        Thread.sleep(1000);
        WebElement approveButton = driver.findElement(By.cssSelector(".btn-approve"));
        ...
        confirmButton.click();
        System.out.println("Test Passed: Đơn hàng đã được xác nhận thành công!");
