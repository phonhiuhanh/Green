...
public class DangerTest {
    ...
    public void testCancelOrder() throws InterruptedException {
        ...
        loginButton.click();
        Thread.sleep(2000);
        driver.get("http://localhost:8080/order/list");
        Thread.sleep(1000);
        WebElement cancelButton = driver.findElement(By.cssSelector(".btn-danger")); // Thay class thành nút hủy
        WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait2.until(ExpectedConditions.elementToBeClickable(cancelButton));
        cancelButton.click();
        ...
        confirmButton.click();
        System.out.println("Test Passed: Đơn hàng đã được hủy thành công!");
    }
